...
alias susu='sudo env HISTFILE=$HISTFILE-root ZDOTDIR=${ZDOTDIR:-$HOME} ZSH=$ZSH ${DISPLAY+DISPLAY=$DISPLAY} ${SSH_TTY+SSH_TTY=$SSH_TTY} ${SSH_AUTH_SOCK+SSH_AUTH_SOCK=$SSH_AUTH_SOCK} zsh -i -l'
